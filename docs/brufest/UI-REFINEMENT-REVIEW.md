...
Label-motion deployment `b94e6f4a-0480-4240-8a3b-78a0666c504c` is Railway `SUCCESS`, source commit `655d115`. The same focused tests pass on the public site at 1366px and 390px, sampling 46 animation frames per viewport and confirming consistent labels, no overshoot, immediate precise dragging, restored drafts and reduced motion. Live receipt: `output/playwright/label-motion-live-qa.txt`; live screenshots: `output/playwright/label-motion-live-1366.png` and `output/playwright/label-motion-live-390.png`.
