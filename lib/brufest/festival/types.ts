...
export type View = { responseInstrument?: string; id: string; mode: 'study'; step: 'pre' | 'contact' | 'waiting' | 'post' | 'complete' | 'stopped' | 'deleted'; message: string; contactChoiceSaved: boolean; permission: boolean; email: string | null; completed: Wave[] };
